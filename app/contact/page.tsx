          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full  border text-black border-gray-300 px-4 py-2 focus:outline-none"
                  required
                />
              </div>
            </div>
            <div>
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                className="w-full bg-[#f7f4ef] border border-gray-300 px-4 py-2 min-h-[100px]"
                required
                placeholder="Please share your query or requirements here…"
              />
            </div>
            ...
            <button
              type="submit"
              className="mt-6 px-8 py-2 bg-black text-white font-semibold tracking-widest text-xs"
              disabled={loading}
            >
